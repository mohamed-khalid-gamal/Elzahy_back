        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GivenBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Awards_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Awards_CreatedByUserId",
                table: "Awards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TwoFactorCodes_UserId_Code_Purpose",
                table: "TwoFactorCodes",
                columns: new[] { "UserId", "Code", "Purpose" });
